...
public class ShipPiece {
	...
	public ShipPiece(boolean isPlayer1) {
		...
		if (isPlayer1)
			shipPieceAlive = new ImageIcon("images\\Player1.png").getImage();
		else
			shipPieceAlive = new ImageIcon("images\\Player2.png").getImage();
		shipIsDead = false;
	}
	...
	public void destroy() {
		shipIsDead = true;
		if (isPlayer1) {
			setShipImage("images\\Player1Hit.png");
		} else {
			setShipImage("images\\Player2Hit.png");
		}
	}
